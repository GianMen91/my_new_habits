...
void main() {
  testWidgets(
      'GreetingSection displays the correct greeting based on time of day',
      (tester) async {
    ...
    await testGreeting(
        tester, 12, 'Good Afternoon'); // Mocking 12 PM (boundary)
...
Future<void> testGreeting(
    WidgetTester tester, int hour, String expectedGreeting) async {
